...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendMessage() {
        ...
        if (msg.isEmpty() || apiKey.isEmpty()) {
            if (apiKey.isEmpty()) Toast.makeText(this, "Pon tu clave API en Ajustes", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private String getAIResponse(String userMsg) {
        ...
        return "Error: Revisa tu clave API.";
    }
    ...
    private void toggleTTS() { if (tts.isSpeaking()) tts.stop(); }
    private void showAttachMenu() { Toast.makeText(this, "Adjuntar archivos", Toast.LENGTH_SHORT).show(); }
    private void openCamera() { Toast.makeText(this, "Cámara", Toast.LENGTH_SHORT).show(); }
}
